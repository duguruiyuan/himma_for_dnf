package com.goule666.dnf.utils;

import com.goule666.dnf.model.UserDetailsDO;
 ...
 * @author niewenlong 2017-10-25 13:45:19
 */
@Component
public class TokenUtils {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        UserDetailsDO user = (UserDetailsDO) userDetails;
